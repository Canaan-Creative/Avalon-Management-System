...
$errormsg = array(
    "Temperature 255. ", 
    "Temperature Higher Than 80. ", 
    "Temperature Lower Than 40. ",  
    "Device Hardware Error Higher Than 5%. ", 
    "Wrong Voltage. ", 
    "Local Works Stopped Growing. ", 
    "Local Works Over 20% Lower Than Average. ", 
    "Fan Stopped. "
);
while($row = mysql_fetch_array($result)){
	  ...
	  <div class="container">
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav">
	        ...
	        <li><a href="javascript:;">Avalon3-290:     <?php echo $aliveMod . "/" . $allMod; ?></a></li>
			...
			<div class="jumbotron">
				<h3>Information List:</h3>
					<table class="table table-bordered table-striped">
						...
						<tbody>
<?php
if(count($newArr) === 0) echo "<tr><td>None</td><td>None</td></tr>";
else{
